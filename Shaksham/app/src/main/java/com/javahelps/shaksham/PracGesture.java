...
import com.javahelps.shaksham.Model;
 ...
 */
public class PracGesture extends AppCompatActivity {
    ...
    String finalAns;
    TextToSpeech t1;
    ImageView cameraBt , half_circle , speaker;
    File mFile;
    Bitmap bitmap;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prac_gesture);

        question = (TextView)findViewById(R.id.question_box2);
        btSubmit = (Button)findViewById(R.id.submitButton2);
        cameraBt = (ImageView)findViewById(R.id.btnCapture2);

        half_circle = (ImageView)findViewById(R.id.iw_half_circle2);
        speaker = (ImageView)findViewById(R.id.iv_speaker2);
        ...
        speak = (RelativeLayout)findViewById(R.id.question_box_speach2);
        ...
        if (caller == 7 && learn == 0){
            half_circle.setVisibility(View.GONE);
            speaker.setVisibility(View.GONE);
            question.setText(questions.get(quesNo).question.toString());
        }
...
//                    Toast.makeText(getApplicationContext(), toSpeak,Toast.LENGTH_SHORT).show();
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mPermissionHelper = new PermissionHelper(PracGesture.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, 100);
...
//                MyApplication.getInstance().addToRequestQueue(myRequest, "tag");
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(ans.equals("true")){
                Intent mintent = new Intent(PracGesture.this, AcceptAnswerActivity.class);
                mintent.putExtra("caller", caller);
                mintent.putExtra("ques", quesNo);
                startActivity(mintent);
                finish();
            }else{
                Intent mintent = new Intent(PracGesture.this, AnswerRejectActivity.class);
                mintent.putExtra("caller", caller);
                mintent.putExtra("ques", quesNo);
                startActivity(mintent);
                finish();
